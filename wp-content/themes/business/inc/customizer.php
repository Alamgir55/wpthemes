...
function business_customize_register($wp_customize){
    ...
    $wp_customize->add_control('banner_heading', array(
     ...
     $wp_customize->add_setting('banner_text', array(
        'default' => _x('Welcome to the Wordpress Business Theme. This theme uses the Twitter Bootstrap 3 framework and can be customize to your liking', 'business'),
        'type' => 'theme_mod'
    ));
    // Text Control
    ...
    $wp_customize->add_setting('box1_text', array(
        'default' => _x('Lorem, ipsum dolor sit amet consectetur adipisicing elit. Omnis, minima!', 'business'),
        'type' => 'theme_mod'
    ));
    // Box 1 Text Control
